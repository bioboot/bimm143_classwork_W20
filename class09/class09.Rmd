...
Folks often view the results of Hierarchical clustering graphicaly. Lets try passing this to the `plot()` function.
...
A "pairs" plot can help when we have small datasets like this one but often we are dealing with data that is too large for these appraches :-(
